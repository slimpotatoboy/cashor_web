export default function PrivacyPolicy() {
  return (
    <div className="py-8 px-4 mx-auto max-w-5xl lg:py-16">
      <h1 className="text-lg font-bold mb-3">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Cashor Business, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cashor Business.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cashor Business, accessible from{" "}
            <a
              href="https://cashor.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://cashor.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: info@dipenmaharjan.com.np</li>
      </ul>
    </div>
  );
}
